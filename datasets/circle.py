...
if __name__ == '__main__':
    from visualize.vis_circle import plot_dataset

    data_path = '/data/qtx/DataSets/Toy_Circle/half-circle.pkl'
    # ds = MultipleEnvironmentCircle(data_path, None, None, None, 2)
    ds = ToyCircle(data_path, [1, 2], 2)
    plot_dataset(ds.data_pkl)
