...
class BaseOptions():
    ...
    def initialize(self):
        ...
        parser.add_argument('--config', type=str, default='../configs/fashion_style_classification.yaml',
                            help='Path to the config file.')
        parser.add_argument('--name', type=str, default='Fashion Style classification',
